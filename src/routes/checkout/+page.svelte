                ...
                >
                    ...
                    <div class="flex flex-row justify-start items-start w-full">
                        <input
                            ...
                            class="input input-bordered w-full mr-5"
                        />
                        <input
                            type="text"
                    ...
                    <div
                        class="flex flex-col justify-start items-start w-50"
                    ></div>
                    <div
                        class="flex flex-col justify-start items-start w-full mt-5"
                    >
                        <input
                            type="email"
                            placeholder="Email"
