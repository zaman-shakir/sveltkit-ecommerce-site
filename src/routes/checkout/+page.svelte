...
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
        <div class="flex flex-col justify-center items-center w-full space-y-9">
            ...
            <div class="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
                <div class="xl:w-3/5 flex flex-col sm:flex-row xl:flex-col justify-start items-start bg-gray-100 dark:bg-gray-800 py-7 sm:py-0 xl:py-10 px-10 xl:w-full">
                    <div class="mb-5">
                        <p class="text-xl font-bold">Billing Details</p>
                    </div>
                    <div class="flex flex-row justify-start items-start w-full">
                        <input type="text" placeholder="First name" class="input input-bordered w-full mr-5 " />
                        <input type="text" placeholder="Last name" class="input input-bordered w-full ml-5 " />
                    </div>
                ...
                <div class="p-8 bg-gray-100 dark:bg-gray-800 flex flex-col lg:w-full xl:w-3/5">
                    ...
                    <div class="mt-2 flex-col">
                        <div class="relative">
                            ...
                            <svg id="closeIcon" class="cursor-pointer absolute top-4 right-4" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.5 5.75L8 10.25L12.5 5.75" stroke="#27272A" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <svg id="openIcon" class="cursor-pointer hidden transform rotate-180 absolute top-4 right-4" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.5 5.75L8 10.25L12.5 5.75" stroke="#27272A" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <div id="dropdown" class="mt-1 hidden absolute z-10 w-full flex bg-gray-50 justify-start flex-col text-gray-600">
                                <div  class="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2">China</div>
                                <div  class="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2">Russia</div>
                                <div  class="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2">UK</div>
                            </div>
                        </div>
