        ...
        <div class="py-8">
            <div class="container grid grid-cols-2 gap-6 mx-auto">
                ...
                <div>
                    ...
                    <div
                        class="flex items-baseline mb-1 space-x-2 font-roboto mt-4"
                    >
                    ...
                    <p class="mt-4 text-gray-600">
                        Get access to thousands of TV shows and movies with a
                        Netflix Gift Card. Watch the most popular films and
                        shows from any device anywhere. Stream Netflix on your
                        smartphone, tablet, smart TV, or game console.
                    </p>

                    <div class="mt-4">
                        <h3 class="text-sm text-gray-800 uppercase mb-1">
                            Quantity
                        </h3>
                        <div
                    ...
                    >
                        ...
                        >
                            <i class="gg-heart" /> Wishlist
                        </a>
                    </div>
                    <div
                        class="product-trust-badge pt-5 p-15 bg-base-300 flex flex-col items-center"
                    >
                        <div class="trust-badge-image" style="width: 350px;">
                            <img
                                loading="lazy"
                                src="https://wpdemo.triple-a.io/wp-content/uploads/2022/11/Group-101.png"
                                width="315"
                                height="20"
                                alt="Secure checkout"
                        ...
                        <div class="trust-badge-text py-5">
            ...
            <div class="container py-16 mx-auto">
                ...
                <div class="w-3/5 pt-6">
                    <div class="text-gray-600">
                        <p class="py-4">
                            Get access to thousands of TV shows and movies with
                            a Netflix Gift Card. Watch the most popular films
                            and shows from any device anywhere. Stream Netflix
                            on your smartphone, tablet, smart TV, or game
                            console.
                        </p>
                        <p class="py-4">
                            Watch exclusive Netflix movies and shows with
                            unlimited streaming. Funds can be added to any
                            existing Netflix account or used with a new account.
                            Netflix Gift Cards make a perfect gift for
                            birthdays, holidays, stocking stuffers, and
                            graduation or as a simple way to say ‘thank you’.
                            Give the gift of entertainment with a gift card for
                            Netflix
                        </p>
                    </div>
                </div>
            ...
            <div class="container pb-16 mx-auto">
                ...
                <div class="grid grid-cols-4 gap-6">
                    {#each Products.item.slice(0, 4) as product, index}
